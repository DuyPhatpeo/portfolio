  ...
  return (
    <section id="projects" className="py-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Modal chi tiết với Framer Motion */}
        <AnimatePresence>
          {selected && (
            <motion.div
            ...
            >
              <motion.div
                className="relative w-full max-w-4xl bg-gradient-to-br from-white via-white to-gray-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 rounded-3xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto border border-white/20 dark:border-white/10"
