  ...
  return (
    <AnimatePresence>
      {selected && (
        ...
        >
          <motion.div
            className="relative w-full max-w-5xl bg-[#0a0a0a] border border-white/10 overflow-hidden max-h-[90vh] overflow-y-auto"
          ...
          >
            {/* Close Button */}
            <button
              className="absolute top-6 right-6 z-30 p-2 text-white/60 hover:text-white transition-colors"
              onClick={onClose}
            >
            ...
            <div className="p-12 space-y-10">
              ...
              >
                <div className="flex gap-4 bg-[#1a1a1a] rounded-lg border border-white/5 p-4">
              ...
              >
                <p className="text-gray-400 leading-relaxed text-base text-center">
                  {selected.desc}
                </p>
              </motion.div>
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-6 py-3 bg-[#1a1a1a] text-white font-medium rounded-lg border border-white/10 hover:border-white/20 transition-colors"
                >
                  <span>Github</span>
