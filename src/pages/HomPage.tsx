...
const HomePage: React.FC = () => {
  ...
  // Scroll với offset cho sticky header
  const scrollToSection = (id: string) => {
    const el = document.getElementById(id);
    if (el) {
      const yOffset = -64; // chiều cao header
  ...
  return (
    <div className="flex flex-col min-h-screen transition-colors duration-500 bg-transparent text-gray-900 dark:text-gray-100">
      ...
      <main className="flex-1">
        ...
        <section
          id="home"
          className="min-h-screen flex flex-col justify-center items-center text-center px-4 bg-gradient-to-b from-gray-50 dark:from-gray-900"
        >
